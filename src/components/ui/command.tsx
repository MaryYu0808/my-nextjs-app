...
>(({ className, ...props }, ref) => (
  <div className="flex items-center border-b px-3" style={{ borderColor: 'var(--t-border)' }}>
    <Search className="mr-2 h-4 w-4 opacity-60" />
    <CommandPrimitive.Input
      ref={ref}
      className={cn('flex h-9 w-full bg-transparent py-2 text-sm placeholder:text-[var(--color-text-muted)]', className)}
      {...props}
    />
  </div>
))
...
>(({ className, ...props }, ref) => (
  <CommandPrimitive.Item
    ref={ref}
    className={cn('relative flex cursor-default select-none items-center rounded-md px-2 py-2 text-sm data-[selected=true]:bg-[var(--t-ghost-bg)]', className)}
    {...props}
  />
))
